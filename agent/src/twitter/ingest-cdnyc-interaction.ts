...
export const ingestCdnycInteractionTweets = inngest.createFunction(
  ...
  async () => {
     ...
     */
    const searchQuery = `("Zohran Mamdani" OR "Zohran" OR "Eric Adams" OR "Cuomo" OR "Curtis Sliwa" OR "Jim Walden" OR "CUNY" OR "NYCHA" OR "Socialist NYC") -filter:replies -from:CityDeskNYC lang:en within_time:7m`;
