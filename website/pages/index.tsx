      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <stop offset="1" stop-color="#4E5F99" />
          </linearGradient>
        </defs>
      </svg>
      ...
      <div className="min-h-screen container mx-auto px-4 py-5">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-america">
              DOGEai
            </p>
          </div>
                  ...
                  >
                    ...
                    <defs>
                      <linearGradient
                        ...
                        gradientUnits="userSpaceOnUse"
                      >
                        <stop offset="0.007284" stop-color="#DF2421" />
                        <stop offset="0.5" stop-color="white" />
                        <stop offset="1" stop-color="#2065E9" />
                      </linearGradient>
                      <linearGradient
